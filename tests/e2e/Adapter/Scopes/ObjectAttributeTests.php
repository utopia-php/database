...
trait ObjectAttributeTests
{
    public function testObjectAttribute(): void
    {
        ...
        $this->assertSame(true, $database->createAttribute($collectionId, 'meta', Database::VAR_OBJECT, 0, false));
        ...
        $this->assertSame(25, $doc1->getAttribute('meta')['age']);
        $this->assertSame(['react', 'node'], $doc1->getAttribute('meta')['skills']);
        $this->assertSame('IN', $doc1->getAttribute('meta')['user']['info']['country']);
        ...
        $this->assertCount(1, $results);
        $this->assertSame('doc2', $results[0]->getId());
        ...
        $this->assertSame(26, $updatedDoc->getAttribute('meta')['age']);
        $this->assertSame(['react', 'node', 'typescript'], $updatedDoc->getAttribute('meta')['skills']);
        $this->assertSame('CA', $updatedDoc->getAttribute('meta')['user']['info']['country']);
        ...
        $this->assertSame('doc1', $fetchedDoc->getId());
        $this->assertIsArray($fetchedDoc->getAttribute('meta'));
        $this->assertSame(26, $fetchedDoc->getAttribute('meta')['age']);
        $this->assertSame(['react', 'node', 'typescript'], $fetchedDoc->getAttribute('meta')['skills']);
        $this->assertSame('CA', $fetchedDoc->getAttribute('meta')['user']['info']['country']);
        ...
        $this->assertSame(26, $results[0]->getAttribute('meta')['age']);
        ...
        $this->assertSame('deep_value', $doc5->getAttribute('meta')['level1']['level2']['level3']['level4']['level5']);
        ...
        $this->assertCount(1, $results);
        $this->assertSame('doc5', $results[0]->getId());
        ...
        $this->assertSame('text', $doc6->getAttribute('meta')['string']);
        $this->assertSame(42, $doc6->getAttribute('meta')['number']);
        $this->assertSame(3.14, $doc6->getAttribute('meta')['float']);
        ...
        $this->assertCount(1, $results);
        $this->assertSame('doc6', $results[0]->getId());
        ...
        $this->assertCount(1, $results);
        $this->assertSame('doc7', $results[0]->getId());
        ...
        $this->assertCount(1, $results);
        $this->assertSame('doc8', $results[0]->getId());
        ...
        $this->assertSame('Project A', $doc9->getAttribute('meta')['projects'][0]['name']);
        ...
        $this->assertCount(1, $results);
        $this->assertSame('doc9', $results[0]->getId());
        ...
        $this->assertSame('Test with "quotes" and \'apostrophes\'', $doc10->getAttribute('meta')['description']);
        $this->assertSame('🚀🎉', $doc10->getAttribute('meta')['emoji']);
        ...
        $this->assertCount(1, $results);
        $this->assertSame('doc10', $results[0]->getId());
        ...
        $this->assertCount(1, $results);
        $this->assertSame('doc11', $results[0]->getId());
        ...
        $this->assertSame([1, 2, 3], $doc12->getAttribute('meta')['matrix'][0]);
        ...
        $this->assertCount(1, $results);
        $this->assertSame('doc12', $results[0]->getId());

        // Test 33: Test getDocument with various documents
        $fetchedDoc6 = $database->getDocument($collectionId, 'doc6');
        $this->assertSame('doc6', $fetchedDoc6->getId());
        $this->assertSame('text', $fetchedDoc6->getAttribute('meta')['string']);
        $this->assertSame(42, $fetchedDoc6->getAttribute('meta')['number']);
        $this->assertTrue($fetchedDoc6->getAttribute('meta')['boolean']);

        $fetchedDoc10 = $database->getDocument($collectionId, 'doc10');
        $this->assertSame('🚀🎉', $fetchedDoc10->getAttribute('meta')['emoji']);
        $this->assertSame('Test with "quotes" and \'apostrophes\'', $fetchedDoc10->getAttribute('meta')['description']);
        ...
        $this->assertCount(1, $results);
        $this->assertSame('doc5', $results[0]->getId());
        $this->assertSame('deep_value', $results[0]->getAttribute('meta')['level1']['level2']['level3']['level4']['level5']);
        ...
        $this->assertCount(1, $results);
        $this->assertIsArray($results[0]->getAttribute('meta'));
        $this->assertSame(['php', 'javascript', 'python', 'go', 'rust'], $results[0]->getAttribute('meta')['tags']);
    ...
    public function testObjectAttributeGinIndex(): void
    {
        ...
        // Create object attribute
        $this->assertSame(true, $database->createAttribute($collectionId, 'data', Database::VAR_OBJECT, 0, false));
        ...
        $this->assertCount(1, $results);
        $this->assertSame('gin1', $results[0]->getId());
        ...
        $this->assertCount(1, $results);
        $this->assertSame('gin2', $results[0]->getId());
    ...
    public function testObjectAttributeInvalidCases(): void
    {
        ...
        $this->assertSame('large_structure', $fetchedLargeDoc->getId());
        $this->assertIsArray($fetchedLargeDoc->getAttribute('meta'));
        $this->assertCount(50, $fetchedLargeDoc->getAttribute('meta'));
        $this->assertSame(25, $fetchedLargeDoc->getAttribute('meta')['key_25']['id']);
        $this->assertSame('Item 25', $fetchedLargeDoc->getAttribute('meta')['key_25']['name']);
        ...
        $this->assertIsArray($results[0]->getAttribute('meta'));
        $this->assertSame('John', $results[0]->getAttribute('meta')['name']);
        $this->assertSame(30, $results[0]->getAttribute('meta')['age']);
        ...
        $this->assertSame('John', $fetchedValid1->getAttribute('meta')['name']);
        $this->assertTrue($fetchedValid1->getAttribute('meta')['settings']['notifications']);
        $this->assertSame('dark', $fetchedValid1->getAttribute('meta')['settings']['theme']);
        ...
        $this->assertSame(true, $database->createAttribute($collectionId, 'settings', Database::VAR_OBJECT, 0, false, $defaultSettings));
    ...
    public function testObjectAttributeDefaults(): void
    {
        ...
        $this->assertSame(true, $database->createAttribute($collectionId, 'metaDefaultEmpty', Database::VAR_OBJECT, 0, false, []));
        ...
        $this->assertSame(true, $database->createAttribute($collectionId, 'profile', Database::VAR_OBJECT, 0, true, null));

        // 4) Required with default (should auto-populate)
        $this->assertSame(true, $database->createAttribute($collectionId, 'profile2', Database::VAR_OBJECT, 0, false, ['name' => 'anon']));

        // 5) Explicit null default
        $this->assertSame(true, $database->createAttribute($collectionId, 'misc', Database::VAR_OBJECT, 0, false, null));
        ...
        $this->assertSame('light', $doc->getAttribute('settings')['config']['theme']);
        $this->assertSame('en', $doc->getAttribute('settings')['config']['lang']);

        // profile provided explicitly
        $this->assertSame('provided', $doc->getAttribute('profile')['name']);

        // profile2 required with default should be auto-populated
        $this->assertIsArray($doc->getAttribute('profile2'));
        $this->assertSame('anon', $doc->getAttribute('profile2')['name']);
    ...
    public function testMetadataWithVector(): void
    {
        ...
        $this->assertCount(1, $results);
        $this->assertSame('vecA', $results[0]->getId());
        ...
        $this->assertCount(1, $results);
        $this->assertSame('vecB', $results[0]->getId());
