...
class StructureTest extends TestCase
{
    ...
    public function testArrayOfStringsValidation(): void
    {
        ...
        $this->assertEquals('Invalid document structure: Attribute "tags[\'0\']" has invalid type. Value must be a valid string and at least 1 chars and no longer than 55 chars', $validator->getDescription());
