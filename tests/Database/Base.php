...
abstract class Base extends TestCase
{
    ...
    public function setUp(): void
    {
        if (is_null(self::$authorizationSingleton)) {
            ...
            self::$authorizationSingleton->setRole('any');
        }

        $this->authorization = self::$authorizationSingleton;
        $this->authorization->setRole('any');
    }
    ...
    public function testCreateExistsDelete(): void
    {
        ...
        if (!$schemaSupport) {
            $this->assertEquals(true, $this->getDatabase()->setDefaultDatabase($this->testDatabase));
    ...
    public function testIndexValidation(): void
    {
        ...
        $validator = new Index($this->getDatabase()->getAdapter()->getMaxIndexLength());
    ...
    {
        $this->assertInstanceOf('Utopia\Database\Document', $this->getDatabase()->createCollection('actors'));
        ...
        $this->assertInstanceOf('Utopia\Database\Document', $this->getDatabase()->createCollection('actors2'));
        $this->assertCount(3, $this->getDatabase()->listCollections());
        ...
        $this->assertInstanceOf('Utopia\Database\Document', $this->getDatabase()->updateDocument($collection->getCollection(), $collection->getId(), $collection));
    ...
    public function testFind(): array
    {
        ...
        $this->assertEquals(true, $this->getDatabase()->createAttribute('movies', 'generes', Database::VAR_STRING, 32, true, null, true, true));
    ...
    public function testFindCheckPermissions(): void
    {
         ...
         * Check Permissions
         */
        $this->authorization->setRole('user:x');
        $documents = $this->getDatabase()->find('movies');
    ...
    {
        if ($this->getDatabase()->getAdapter()->getSupportForTimeouts()) {
            $this->getDatabase()->createCollection('timeouts');
            $this->assertEquals(true, $this->getDatabase()->createAttribute('timeouts', 'longtext', Database::VAR_STRING, 100000000, true));

            for ($i = 0 ; $i <= 5 ; $i++) {
                $this->getDatabase()->createDocument('timeouts', new Document([
                    'longtext' => file_get_contents(__DIR__ . '/../resources/longtext.txt'),
                    '$permissions' => [
                        Permission::read(Role::any()),
                        Permission::update(Role::any()),
            ...
            $this->getDatabase()->find('timeouts', [
                Query::notEqual('longtext', 'appwrite'),
            ], 1);
        }
    ...
    public function testCount(): void
    {
        ...
        $this->authorization->unsetRole('user:x');
        $count = $this->getDatabase()->count('movies');
    ...
    public function testSum(): void
    {
        ...
        $this->authorization->unsetRole('user:x');
        $this->authorization->unsetRole('userx');
        $sum = $this->getDatabase()->sum('movies', 'year', [Query::equal('year', [2019]),]);
        $this->assertEquals(2019 + 2019, $sum);
        $sum = $this->getDatabase()->sum('movies', 'year');
    ...
    {
        $this->authorization->setRole(Role::users()->toString());
    ...
    public function testEnforceRelationshipPermissions(): void
    {
        ...
        $this->authorization->setRole(Role::user('user1')->toString());
        ...
        $this->authorization->setRole(Role::user('user2')->toString());
    ...
    public function testCollectionPermissionsFindWorks(array $data): array
    {
        ...
        $this->authorization->cleanRoles();
        $this->authorization->setRole(Role::user('random')->toString());
    ...
    public function testCollectionPermissionsRelationshipsFindWorks(array $data): void
    {
        ...
        $this->authorization->cleanRoles();
        $this->authorization->setRole(Role::user('unknown')->toString());
    ...
    public function testCreateRelationDocumentWithoutUpdatePermission(): void
    {
        ...
        $this->authorization->cleanRoles();
        $this->authorization->setRole(Role::user('a')->toString());
    ...
    public function testLabels(): void
    {
        ...
        $this->authorization->setRole(Role::label('reader')->toString());
