...
class SumTest extends TestCase
{
    ...
    {
        $this->assertTrue($this->validator->isValid(Query::sum(['value'])));
        $this->assertTrue($this->validator->isValid(Query::sum(['valueFloat'])));
    }
    ...
    public function testValueFailure(): void
    {
        ...
        $this->assertFalse($this->validator->isValid(Query::sum(['valueStr'])));
    }
}
