...
trait CollectionTests
{
    public function testCreateExistsDelete(): void
    {
        ...
        $this->assertSame(true, $database->exists($this->testDatabase));
        $this->assertSame(true, $database->delete($this->testDatabase));
        $this->assertSame(false, $database->exists($this->testDatabase));
        $this->assertSame(true, $database->create());
    }
    ...
    public function testCreateListExistsDeleteCollection(): void
    {
        ...
        $this->assertSame(true, $database->exists($this->testDatabase, 'actors'));
        ...
        $this->assertSame(true, $database->exists($this->testDatabase, 'actors2'));
        ...
        $this->assertSame(true, $database->deleteCollection('actors2')); // Delete collection when finished
        $this->assertCount(1, $database->listCollections());

        $this->assertSame(false, $database->getCollection('actors')->isEmpty());
        $this->assertSame(true, $database->deleteCollection('actors'));
        $this->assertSame(true, $database->getCollection('actors')->isEmpty());
        $this->assertSame(false, $database->exists($this->testDatabase, 'actors'));
    }
    ...
    public function testCreateCollectionWithSchema(): void
    {
        ...
        $this->assertSame('attribute1', $collection->getAttribute('attributes')[0]['$id']);
        $this->assertSame(Database::VAR_STRING, $collection->getAttribute('attributes')[0]['type']);
        $this->assertSame('attribute2', $collection->getAttribute('attributes')[1]['$id']);
        $this->assertSame(Database::VAR_INTEGER, $collection->getAttribute('attributes')[1]['type']);
        $this->assertSame('attribute3', $collection->getAttribute('attributes')[2]['$id']);
        $this->assertSame(Database::VAR_BOOLEAN, $collection->getAttribute('attributes')[2]['type']);
        $this->assertSame('attribute4', $collection->getAttribute('attributes')[3]['$id']);
        $this->assertSame(Database::VAR_ID, $collection->getAttribute('attributes')[3]['type']);

        $this->assertIsArray($collection->getAttribute('indexes'));
        $this->assertCount(4, $collection->getAttribute('indexes'));
        $this->assertSame('index1', $collection->getAttribute('indexes')[0]['$id']);
        $this->assertSame(Database::INDEX_KEY, $collection->getAttribute('indexes')[0]['type']);
        $this->assertSame('index2', $collection->getAttribute('indexes')[1]['$id']);
        $this->assertSame(Database::INDEX_KEY, $collection->getAttribute('indexes')[1]['type']);
        $this->assertSame('index3', $collection->getAttribute('indexes')[2]['$id']);
        $this->assertSame(Database::INDEX_KEY, $collection->getAttribute('indexes')[2]['type']);
        $this->assertSame('index4', $collection->getAttribute('indexes')[3]['$id']);
        $this->assertSame(Database::INDEX_KEY, $collection->getAttribute('indexes')[3]['type']);
        ...
        $this->assertSame(false, $collection2->isEmpty());
        ...
        $this->assertSame('attribute-one', $collection2->getAttribute('attributes')[0]['$id']);
        $this->assertSame(Database::VAR_STRING, $collection2->getAttribute('attributes')[0]['type']);
        $this->assertIsArray($collection2->getAttribute('indexes'));
        $this->assertCount(1, $collection2->getAttribute('indexes'));
        $this->assertSame('index-one', $collection2->getAttribute('indexes')[0]['$id']);
        $this->assertSame(Database::INDEX_KEY, $collection2->getAttribute('indexes')[0]['type']);
    ...
    public function testCreateCollectionValidator(): void
    {
        ...
        foreach ($collections as $id) {
            ...
            $this->assertSame('attribute1', $collection->getAttribute('attributes')[0]['$id']);
            $this->assertSame(Database::VAR_STRING, $collection->getAttribute('attributes')[0]['type']);
            $this->assertSame('attribute-2', $collection->getAttribute('attributes')[1]['$id']);
            $this->assertSame(Database::VAR_INTEGER, $collection->getAttribute('attributes')[1]['type']);
            $this->assertSame('attribute_3', $collection->getAttribute('attributes')[2]['$id']);
            $this->assertSame(Database::VAR_BOOLEAN, $collection->getAttribute('attributes')[2]['type']);
            $this->assertSame('attribute.4', $collection->getAttribute('attributes')[3]['$id']);
            $this->assertSame(Database::VAR_BOOLEAN, $collection->getAttribute('attributes')[3]['type']);

            $this->assertIsArray($collection->getAttribute('indexes'));
            $this->assertCount(5, $collection->getAttribute('indexes'));
            $this->assertSame('index1', $collection->getAttribute('indexes')[0]['$id']);
            $this->assertSame(Database::INDEX_KEY, $collection->getAttribute('indexes')[0]['type']);
            $this->assertSame('index-2', $collection->getAttribute('indexes')[1]['$id']);
            $this->assertSame(Database::INDEX_KEY, $collection->getAttribute('indexes')[1]['type']);
            $this->assertSame('index_3', $collection->getAttribute('indexes')[2]['$id']);
            $this->assertSame(Database::INDEX_KEY, $collection->getAttribute('indexes')[2]['type']);
            $this->assertSame('index.4', $collection->getAttribute('indexes')[3]['$id']);
            $this->assertSame(Database::INDEX_KEY, $collection->getAttribute('indexes')[3]['type']);
    ...
    public function testPurgeCollectionCache(): void
    {
        ...
        $this->assertSame(true, $database->createAttribute('redis', 'name', Database::VAR_STRING, 128, true));
        $this->assertSame(true, $database->createAttribute('redis', 'age', Database::VAR_INTEGER, 0, true));
        ...
        $this->assertSame(true, $database->deleteAttribute('redis', 'age'));
    ...
    public function testSchemaAttributes(): void
    {
        ...
        $this->assertSame('username', $attribute['$id']);
        $this->assertSame('varchar', $attribute['dataType']);
        $this->assertSame('varchar(128)', $attribute['columnType']);
        $this->assertSame('128', $attribute['characterMaximumLength']);
        $this->assertSame('YES', $attribute['isNullable']);

        $attribute = $attributes['story'];
        $this->assertSame('story', $attribute['$id']);
        $this->assertSame('text', $attribute['dataType']);
        $this->assertSame('text', $attribute['columnType']);
        $this->assertSame('65535', $attribute['characterMaximumLength']);

        $attribute = $attributes['string_list'];
        $this->assertSame('string_list', $attribute['$id']);
        ...
        $this->assertSame('dob', $attribute['$id']);
        $this->assertSame('datetime', $attribute['dataType']);
        $this->assertSame('datetime(3)', $attribute['columnType']);
        $this->assertSame(null, $attribute['characterMaximumLength']);
        $this->assertSame('3', $attribute['datetimePrecision']);

        if ($db->getSharedTables()) {
            $attribute = $attributes['_tenant'];
            $this->assertSame('_tenant', $attribute['$id']);
            $this->assertSame('int', $attribute['dataType']);
            $this->assertSame('10', $attribute['numericPrecision']);
    ...
    public function testRowSizeToLarge(): void
    {
        ...
        $this->assertSame(true, $database->createAttribute($collection_1->getId(), 'attr_1', Database::VAR_STRING, 16000, true));
    ...
    public function testCreateCollectionWithSchemaIndexes(): void
    {
        ...
        $this->assertSame($collection->getAttribute('indexes')[0]['attributes'][0], 'username');
        $this->assertSame($collection->getAttribute('indexes')[0]['lengths'][0], null);

        $this->assertSame($collection->getAttribute('indexes')[1]['attributes'][0], 'username');
        $this->assertSame($collection->getAttribute('indexes')[1]['lengths'][0], 99);
        $this->assertSame($collection->getAttribute('indexes')[1]['orders'][0], Database::ORDER_DESC);

        if ($database->getAdapter()->getSupportForIndexArray()) {
            $this->assertSame($collection->getAttribute('indexes')[2]['attributes'][0], 'cards');
            $this->assertSame($collection->getAttribute('indexes')[2]['lengths'][0], Database::MAX_ARRAY_INDEX_LENGTH);
            $this->assertSame($collection->getAttribute('indexes')[2]['orders'][0], null);
        }
    }
    ...
    public function testKeywords(): void
    {
        ...
        foreach ($keywords as $keyword) {
            ...
            $this->assertSame($keyword, $collection->getId());
            ...
            $this->assertSame('helloWorld', $document->getId());
            ...
            $this->assertSame('helloWorld', $documents[0]->getId());
        ...
        foreach ($keywords as $keyword) {
            ...
            $this->assertSame('reservedKeyDocument', $document->getId());
            $this->assertSame('Reserved:' . $keyword, $document->getAttribute($keyword));
            ...
            $this->assertCount(1, $documents);
            $this->assertSame('reservedKeyDocument', $documents[0]->getId());
            $this->assertSame('Reserved:' . $keyword, $documents[0]->getAttribute($keyword));
    ...
    public function testDeleteCollectionDeletesRelationships(): void
    {
        ...
        $this->assertSame(1, \count($testers->getAttribute('attributes')));
        $this->assertSame(1, \count($devices->getAttribute('attributes')));
        $this->assertSame(1, \count($devices->getAttribute('indexes')));
        ...
        $this->assertSame(true, $testers->isEmpty());
        $this->assertSame(0, \count($devices->getAttribute('attributes')));
        $this->assertSame(0, \count($devices->getAttribute('indexes')));
    }
    ...
    public function testCascadeMultiDelete(): void
    {
        ...
        $this->assertSame(true, $database->deleteDocument('cascadeMultiDelete1', $root->getId()));

        $multi2 = $database->getDocument('cascadeMultiDelete2', 'cascadeMultiDelete2');
        $this->assertSame(true, $multi2->isEmpty());

        $multi3 = $database->getDocument('cascadeMultiDelete3', 'cascadeMultiDelete3');
        $this->assertSame(true, $multi3->isEmpty());
    }
    ...
    public function testSharedTables(): void
    {
        ...
        $this->assertSame(true, $database->exists('schema1'));
        ...
        $this->assertSame(true, $database->exists('schema2'));
        ...
        $this->assertSame(true, $database->exists('sharedTables'));
        ...
        $this->assertSame($tenant1, $doc->getTenant());
        ...
        $doc = $database->getDocument('people', $docId);
        $this->assertSame([Permission::read(Role::any())], $doc['$permissions']);
        $this->assertSame($tenant1, $doc->getTenant());
        ...
        $doc = $database->getDocument('people', $docId);
        $this->assertSame([Permission::read(Role::any()), Permission::delete(Role::any())], $doc['$permissions']);
    ...
    public function testSharedTablesDuplicates(): void
    {
        ...
        $this->assertSame(1, \count($collection->getAttribute('attributes')));
