    ...
    public function isValid($value): bool
    {
        ...
        foreach ($value as $query) {
            ...
            $methodType = match ($method) {
                ...
                Query::TYPE_SPATIAL_CROSSES,
                Query::TYPE_SPATIAL_NOT_CROSSES,
                Query::TYPE_SPATIAL_DISTANCE,
                Query::TYPE_SPATIAL_NOT_DISTANCE,
                Query::TYPE_SPATIAL_EQUALS,
                Query::TYPE_SPATIAL_NOT_EQUALS,
                Query::TYPE_SPATIAL_INTERSECTS,
                Query::TYPE_SPATIAL_NOT_INTERSECTS,
                Query::TYPE_SPATIAL_OVERLAPS,
                Query::TYPE_SPATIAL_NOT_OVERLAPS,
                Query::TYPE_SPATIAL_TOUCHES,
                Query::TYPE_SPATIAL_NOT_TOUCHES => Base::METHOD_TYPE_FILTER,
                default => '',
            };
